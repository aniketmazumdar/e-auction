...
$('#frmCreateProfile').children('input').val('');
                ...
                if(selSecurityQuestion.val() && txtSecurityAnswer.val()){
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            alert(resData);
                            if (resData) {
                                //$('#frmCreateProfile').addClass('hide');
...
// filPhoto change
filPhoto.change(function() {
    if(this.value){
        $('#div-upload-photo').removeClass('hide');
        $('#div-delete-photo').addClass('hide');
    }
    else {
        $('#div-upload-photo').addClass('hide');
        $('#div-delete-photo').removeClass('hide');
    }
});
