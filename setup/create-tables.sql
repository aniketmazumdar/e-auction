...
CREATE TABLE IF NOT EXISTS WEBPAGE_PATH_MASTER (
    ...
    WEBPAGE_PATH_STATUS                     INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
...
CREATE TABLE IF NOT EXISTS WEBPAGE_MASTER (
    ...
    WEBPAGE_STATUS                          INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
...
CREATE TABLE IF NOT EXISTS NAV_TAB_MASTER (
    ...
    NAV_TAB_STATUS                          INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
...
CREATE TABLE IF NOT EXISTS SECURITY_QUESTION_MASTER (
    ...
    SECURITY_QUESTION_STATUS                INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
...
CREATE TABLE IF NOT EXISTS MEMBER_MASTER (
    ...
    MEMBER_ACCOUNT_STATUS                INT NOT NULL COMMENT "VALID VALUES: 0(ACTIVE) 1(DEACTIVE)",
...
CREATE TABLE IF NOT EXISTS CATEGORY_MASTER (
	...
	CATEGORY_STATUS                        INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
...
CREATE TABLE IF NOT EXISTS BIDDING_MASTER (
    ...
    BIDDING_STATUS                      INT NOT NULL COMMENT "VALID VALUES: 0(VISIBLE), 1(INVISIBLE)",
